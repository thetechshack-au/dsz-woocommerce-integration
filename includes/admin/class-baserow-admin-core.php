...
class Baserow_Admin_Core {
    ...
    private function initialize_components() {
        $this->ajax_handler = new Baserow_Admin_Ajax_Handler($this->api_handler, $this->product_importer);
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        // Enqueue Underscore.js for templates
    ...
    public function render_admin_page() {
        require_once BASEROW_IMPORTER_PLUGIN_DIR . 'templates/admin/main-page.php';
    }

    public function render_order_status_page() {
        require_once BASEROW_IMPORTER_PLUGIN_DIR . 'templates/admin/order-status.php';
    }
}
